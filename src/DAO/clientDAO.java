...
public class clientDAO implements objectDao{
    ...
    public int ajouter(Object object_p){
        ...
        try{
            ...
            statement.setString(2,((Client) object_p).getUser().getPassword());
            ...
            statement = connection.prepareStatement("INSERT INTO client(id_compte, nom, mail, monnaie, classe, date_naissance) VALUES (?,?,?,0,?,?);");
